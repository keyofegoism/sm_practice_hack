...
EquipmentMenu:
	...
	DW #$0000, #equipment, #$0000, 				#str_14xice
	DW #$0000, #equipment, #$0000, 				#str_14iceboots
	DW #$0000, #equipment, #$0000, 				#str_14speedboots
...
str_14xice: DB "14% X ICE", #$00
str_14iceboots: DB "14% ICEBOOTS", #$00
str_14speedboots: DB "14% SPEEDBOOTS", #$00
